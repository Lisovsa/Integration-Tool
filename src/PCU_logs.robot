...
*** Variables ***
${path}           ${EMPTY}
${logOutputPath}    C:/Robot Framework/Output/    # Path to logs downloaded from the PCU.
...
Set path
    ...
    # Specify logOutputPath: update scalar variable to set path to the folder where you would like to see tests results.
    ${file_path}=    Replace String    ${logOutputPath}PCU_logs_{}.txt    {}    ${date}
